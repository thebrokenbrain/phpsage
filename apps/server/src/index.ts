...
const aiRagDirectoryPath = resolve(process.cwd(), process.env.AI_RAG_DIRECTORY?.trim() || "docs/rag");
...
const aiIngestDefaultTarget = process.env.AI_INGEST_DEFAULT_TARGET?.trim() || "/workspace/docs/rag";
